...
{
    public static StreamLinkResult? LookUpStream(string streamUrl)
    {
        try
        {
            var process = new Process
            {
                ...
                {
                    FileName = "python",
                    Arguments = $"-m streamlink {streamUrl} --json",
            ...
            return JsonConvert.DeserializeObject<StreamLinkResult>(ssb.ToString());
        }
        catch (Exception e)
        {
